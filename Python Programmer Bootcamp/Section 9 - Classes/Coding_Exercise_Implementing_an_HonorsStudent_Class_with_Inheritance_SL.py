...
class Student(object): # Object is a built-in class template from which all other classes inherit
...
class HonorsStudent(Student):
    ...
    def __init__(self, name, age, major, gpa, year, honors_program):
        # The super function searches the parent class for __init__(name, age, major, gpa, year) so as to initialise
